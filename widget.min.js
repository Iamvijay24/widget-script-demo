(function () {
  ...
  t.rel = "stylesheet";
  t.href = "https://cdn.jsdelivr.net/npm/video.js@8.21.0/dist/video.min.css";
  ...
  n.onload = function () {
    document.addEventListener("DOMContentLoaded", function () {
      ...
      let buttonColor = "bg-indigo-600";
      let botName = "FaceBot Assistant";
      ...
      const createChatBox = () => {
        ...
        chatBox.innerHTML = `
                    <div class="flex justify-between items-center p-4 ${buttonColor} text-white rounded-t-lg">
                        <h5>${botName}</h5>
        ...
        const player = videojs("videoPlayer", {
          ...
          controls: false,
          preload: "auto",
          sources: [{ src: defaultVideos[0], type: "application/x-mpegURL" }],
        ...
        const sendMessage = () => {
          const userInput = document
            ...
            .value.trim()
            .toLowerCase();
          if (videoConditions[userInput]) {
            const videoToPlay =
              videoConditions[userInput][
                Math.floor(Math.random() * videoConditions[userInput].length)
              ];
            player.src({ type: "application/x-mpegURL", src: videoToPlay });
            player.ready(() => {
