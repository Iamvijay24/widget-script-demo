...
`;
  ...
  <div style="position: relative; width: 100%;">
    ...
    <button disabled  id="sendVoice" style="position: absolute; font-size: 14px; top: 50%; right: 75px; transform: translateY(-50%);  color: #ffffff; padding: 8px 16px; border-radius: 8px; border: none; cursor: pointer; transition: background-color 0.3s; cursor: no-drop;">
